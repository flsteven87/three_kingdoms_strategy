/**
 * GroupMeritDistributionTab - Group merit distribution charts
...
export function GroupMeritDistributionTab({
  groupStats,
  members,
  periodTrends,
}: GroupMeritDistributionTabProps) {
  ...
  const meritBins = calculateDistributionBins(members, (m) => m.daily_merit);
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <ChartContainer
              config={groupChartConfigs.meritDistribution}
        ...
        <Card>
          ...
          <CardContent>
            <ChartContainer
              config={groupChartConfigs.meritTrend}
              className="h-[220px] w-full"
            >
                  ...
                  content={({ active, payload }) => {
                    ...
                    return (
                      <div className="rounded-lg border bg-background p-2 shadow-sm">
                        ...
                        <div className="text-sm">
                          人日均戰功: {formatNumber(data.avgMerit)}
                        </div>
                        <div className="text-sm">
                          人日均助攻: {data.avgAssist}
                        </div>
                      </div>
                    );
                  }}
